!(function (e, t) {
  ...
  function i(i, s) {
    ...
    if (i)
      if ('string' == typeof i) {
        ...
        } else for (o = s || '#' !== i[0] || i.match(/[ .<>:~]/) ? (s || e).querySelectorAll(i.trim()) : [e.getElementById(i.trim().split('#')[1])], n = 0; n < o.length; n += 1) o[n] && r.push(o[n]);
      } else if (i.nodeType || i === t || i === e) r.push(i);
      else if (i.length > 0 && i[0].nodeType) for (n = 0; n < i.length; n += 1) r.push(i[n]);
    return new a(r);
  }
  function s(e) {
  ...
  var r = {
    ...
    on: function () {
      ...
      function l(e) {
        ...
        if (t) {
          ...
          else for (var s = i(t).parents(), o = 0; o < s.length; o += 1) i(s[o]).is(r) && n.apply(s[o], a);
        }
      }
      function d(e) {
      ...
      for (var s = a[0].split(' '), r = a[1], n = 0; n < s.length; n += 1)
        for (var o = s[n], l = 0; l < this.length; l += 1) {
          var d = this[l],
            p = void 0;
          try {
            p = new t.CustomEvent(o, { detail: r, bubbles: !0, cancelable: !0 });
          } catch (t) {
    ...
    append: function () {
      ...
      for (var r = 0; r < i.length; r += 1) {
        ...
        for (var n = 0; n < this.length; n += 1)
          ...
          } else if (t instanceof a) for (var l = 0; l < t.length; l += 1) this[n].appendChild(t[l]);
    ...
    parents: function (e) {
      for (var t = [], a = 0; a < this.length; a += 1) for (var r = this[a].parentNode; r; ) e ? i(r).is(e) && t.push(r) : t.push(r), (r = r.parentNode);
      return i(s(t));
    },
    closest: function (e) {
      var t = this;
      ...
      parseUrlQuery: function (e) {
        ...
        if ('string' == typeof o && o.length)
          for (
            ...
            (s = i[a].replace(/#\S+/g, '').split('=')), (n[decodeURIComponent(s[0])] = void 0 === s[1] ? void 0 : decodeURIComponent(s[1]) || '');
        return n;
      },
      isObject: function (e) {
  ...
  var h = {
    updateSize: function () {
      ...
      (e = void 0 !== a.params.width ? a.params.width : i[0].clientWidth),
        ...
        (0 === e && a.isHorizontal()) ||
          (0 === t && a.isVertical()) ||
          ((e = e - parseInt(i.css('padding-left'), 10) - parseInt(i.css('padding-right'), 10)), (t = t - parseInt(i.css('padding-top'), 10) - parseInt(i.css('padding-bottom'), 10)), d.extend(a, { width: e, height: t, size: a.isHorizontal() ? e : t }));
    },
    updateSlides: function () {
      ...
      if (void 0 !== s) {
        ...
        'string' == typeof y && y.indexOf('%') >= 0 && (y = (parseFloat(y.replace('%', '')) / 100) * s),
          (e.virtualSize = -y),
          r ? c.css({ marginLeft: '', marginTop: '' }) : c.css({ marginRight: '', marginBottom: '' }),
          a.slidesPerColumn > 1 &&
            ((S = Math.floor(u / a.slidesPerColumn) === u / e.params.slidesPerColumn ? u : Math.ceil(u / a.slidesPerColumn) * a.slidesPerColumn),
            'auto' !== a.slidesPerView && 'row' === a.slidesPerColumnFill && (S = Math.max(S, a.slidesPerView * a.slidesPerColumn)));
        for (var M, k = a.slidesPerColumn, P = S / k, z = P - (a.slidesPerColumn * P - u), $ = 0; $ < u; $ += 1) {
          C = 0;
          var L = c.eq($);
          if (a.slidesPerColumn > 1) {
            ...
            'column' === a.slidesPerColumnFill
              ? ((O = $ - (D = Math.floor($ / k)) * k),
                (D > z || (D === z && O === k - 1)) && (O += 1) >= k && ((O = 0), (D += 1)),
                (I = D + (O * S) / k),
                L.css({ '-webkit-box-ordinal-group': I, '-moz-box-ordinal-group': I, '-ms-flex-order': I, '-webkit-order': I, order: I }))
              : (D = $ - (O = Math.floor($ / P)) * P),
              L.css('margin-' + (e.isHorizontal() ? 'top' : 'left'), 0 !== O && a.spaceBetween && a.spaceBetween + 'px')
          ...
          if ('none' !== L.css('display')) {
              ...
              N && (L[0].style.transform = 'none'),
                ...
                (C = a.roundLengths
                  ? e.isHorizontal()
                    ...
                    : L.outerHeight(!0)
                  : e.isHorizontal()
                  ? parseFloat(A.getPropertyValue('width')) + parseFloat(A.getPropertyValue('margin-left')) + parseFloat(A.getPropertyValue('margin-right'))
                  : parseFloat(A.getPropertyValue('height')) + parseFloat(A.getPropertyValue('margin-top')) + parseFloat(A.getPropertyValue('margin-bottom'))),
            ...
            c[$] && (c[$].swiperSlideSize = C),
              f.push(C),
              a.centeredSlides
                ? ((x = x + C / 2 + T / 2 + y), 0 === T && 0 !== $ && (x = x - s / 2 - y), 0 === $ && (x = x - s / 2 - y), Math.abs(x) < 0.001 && (x = 0), a.roundLengths && (x = Math.floor(x)), E % a.slidesPerGroup == 0 && h.push(x), v.push(x))
                : (a.roundLengths && (x = Math.floor(x)), E % a.slidesPerGroup == 0 && h.push(x), v.push(x), (x = x + C + y)),
              (e.virtualSize += C + y),
              (T = C),
              (E += 1);
          }
        ...
        if (
          ...
          (p.flexbox && !a.setWrapperSize) || (e.isHorizontal() ? i.css({ width: e.virtualSize + a.spaceBetween + 'px' }) : i.css({ height: e.virtualSize + a.spaceBetween + 'px' })),
          a.slidesPerColumn > 1 &&
            ((e.virtualSize = (C + a.spaceBetween) * S),
        ...
        if ((0 === h.length && (h = [0]), 0 !== a.spaceBetween && (e.isHorizontal() ? (r ? c.css({ marginLeft: y + 'px' }) : c.css({ marginRight: y + 'px' })) : c.css({ marginBottom: y + 'px' })), a.centerInsufficientSlides)) {
          var V = 0;
          if (
        ...
        d.extend(e, { slides: c, snapGrid: h, slidesGrid: v, slidesSizesGrid: f }),
    ...
    slideTo: function (e, t, a, i) {
      ...
      return (
        ...
        (u && -f === s.translate) || (!u && f === s.translate)
          ? (s.updateActiveIndex(r), n.autoHeight && s.updateAutoHeight(), s.updateSlidesClasses(), 'slide' !== n.effect && s.setTranslate(f), 'reset' !== v && (s.transitionStart(a, v), s.transitionEnd(a, v)), !1)
          : (0 !== t && p.transition
              ? (s.setTransition(t),
                s.setTranslate(f),
              ...
              : (s.setTransition(0), s.setTranslate(f), s.updateActiveIndex(r), s.updateSlidesClasses(), s.emit('beforeTransitionStart', t, i), s.transitionStart(a, v), s.transitionEnd(a, v)),
            !0)
      );
    },
  ...
  var g = {
    ...
    loopFix: function () {
      ...
      i < r
        ...
        : (('auto' === a.slidesPerView && i >= 2 * r) || i >= s.length - r) && ((e = -s.length + i + r), (e += r), t.slideTo(e, 0, !1, !0) && 0 !== p && t.setTranslate((d ? -t.translate : t.translate) - p));
  ...
  var w = {
    ...
    y = (function () {
      ...
      if (
        ...
        r && !s && ((i.os = 'android'), (i.osVersion = r[2]), (i.android = !0), (i.androidChrome = a.toLowerCase().indexOf('chrome') >= 0)),
        (n || l || o) && ((i.os = 'ios'), (i.ios = !0)),
        l && !o && ((i.osVersion = l[2].replace(/_/g, '.')), (i.iphone = !0)),
        n && ((i.osVersion = n[2].replace(/_/g, '.')), (i.ipad = !0)),
        o && ((i.osVersion = o[3] ? o[3].replace(/_/g, '.') : null), (i.iphone = !0)),
  ...
  var T = {
    attachEvents: function () {
          ...
          if ((l.originalEvent && (l = l.originalEvent), (r.isTouchEvent = 'touchstart' === l.type), (r.isTouchEvent || !('which' in l) || 3 !== l.which) && !((!r.isTouchEvent && 'button' in l && l.button > 0) || (r.isTouched && r.isMoved))))
            if (n.noSwiping && i(l.target).closest(n.noSwipingSelector ? n.noSwipingSelector : '.' + n.noSwipingClass)[0]) s.allowClick = !0;
              ...
              if (!u || !(p <= h || p >= t.screen.width - h)) {
                if (
                  (d.extend(r, { isTouched: !0, isMoved: !1, allowTouchCallbacks: !0, isScrolling: void 0, startMoving: void 0 }),
                  (o.startX = p),
                  (o.startY = c),
        ...
        (a.onTouchMove = function (t) {
          ...
          if ((l.originalEvent && (l = l.originalEvent), s.isTouched)) {
            if (!s.isTouchEvent || 'mousemove' !== l.type) {
              ...
              if (!a.allowTouchMove) return (a.allowClick = !1), void (s.isTouched && (d.extend(n, { startX: p, startY: c, currentX: p, currentY: c }), (s.touchStartTime = d.now())));
                  ...
                  if (
                    (void 0 === s.isScrolling &&
                      ((a.isHorizontal() && n.currentY === n.startY) || (a.isVertical() && n.currentX === n.startX)
                        ? (s.isScrolling = !1)
                        : h * h + v * v >= 25 && ((u = (180 * Math.atan2(Math.abs(v), Math.abs(h))) / Math.PI), (s.isScrolling = a.isHorizontal() ? u > r.touchAngle : 90 - u > r.touchAngle))),
                    ...
                    (n.diff = f), (f *= r.touchRatio), o && (f = -f), (a.swipeDirection = f > 0 ? 'prev' : 'next'), (s.currentTranslate = f + s.startTranslate);
                    var m = !0,
                      g = r.resistanceRatio;
                    if (
                      (r.touchReleaseOnEdges && (g = 0),
                      f > 0 && s.currentTranslate > a.minTranslate()
                        ? ((m = !1), r.resistance && (s.currentTranslate = a.minTranslate() - 1 + Math.pow(-a.minTranslate() + s.startTranslate + f, g)))
                        : f < 0 && s.currentTranslate < a.maxTranslate() && ((m = !1), r.resistance && (s.currentTranslate = a.maxTranslate() + 1 - Math.pow(a.maxTranslate() - s.startTranslate - f, g))),
                    ...
                    r.followFinger &&
                      ...
                      r.freeMode &&
                        (0 === s.velocities.length && s.velocities.push({ position: n[a.isHorizontal() ? 'startX' : 'startY'], time: s.touchStartTime }), s.velocities.push({ position: n[a.isHorizontal() ? 'currentX' : 'currentY'], time: d.now() })),
        ...
        (a.onTouchEnd = function (e) {
          ...
          if (
            (t.allowClick &&
              ...
              h < 300 && u - a.lastClickTime < 300 && (a.clickTimeout && clearTimeout(a.clickTimeout), t.emit('doubleTap', p))),
          ...
          if (((a.isTouched = !1), (a.isMoved = !1), (a.startMoving = !1), (c = i.followFinger ? (r ? t.translate : -t.translate) : -a.currentTranslate), i.freeMode)) {
            ...
            for (var k = 0, P = t.slidesSizesGrid[0], z = 0; z < o.length; z += i.slidesPerGroup)
              void 0 !== o[z + i.slidesPerGroup] ? c >= o[z] && c < o[z + i.slidesPerGroup] && ((k = z), (P = o[z + i.slidesPerGroup] - o[z])) : c >= o[z] && ((k = z), (P = o[o.length - 1] - o[o.length - 2]));
            var $ = (c - o[k]) / P;
            if (h > i.longSwipesMs) {
      ...
      if (p.touch || (!p.pointerEvents && !p.prefixedPointerEvents)) {
        if (p.touch) {
          var u = !('touchstart' !== r.start || !p.passiveListener || !s.passiveListeners) && { passive: !0, capture: !1 };
          l.addEventListener(r.start, a.onTouchStart, u), l.addEventListener(r.move, a.onTouchMove, p.passiveListener ? { passive: !1, capture: c } : c), l.addEventListener(r.end, a.onTouchEnd, u);
        }
        ((s.simulateTouch && !y.ios && !y.android) || (s.simulateTouch && !p.touch && y.ios)) && (l.addEventListener('mousedown', a.onTouchStart, !1), e.addEventListener('mousemove', a.onTouchMove, c), e.addEventListener('mouseup', a.onTouchEnd, !1));
      ...
      (s.preventClicks || s.preventClicksPropagation) && l.addEventListener('click', a.onClick, !0), a.on(y.ios || y.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate', x, !0);
    },
    detachEvents: function () {
      ...
      if (p.touch || (!p.pointerEvents && !p.prefixedPointerEvents)) {
        if (p.touch) {
          var l = !('onTouchStart' !== i.start || !p.passiveListener || !a.passiveListeners) && { passive: !0, capture: !1 };
        ...
        ((a.simulateTouch && !y.ios && !y.android) || (a.simulateTouch && !p.touch && y.ios)) && (n.removeEventListener('mousedown', t.onTouchStart, !1), e.removeEventListener('mousemove', t.onTouchMove, o), e.removeEventListener('mouseup', t.onTouchEnd, !1));
  ...
  var C = {
      ...
      classes: {
        addClasses: function () {
          ...
          s.push(t.direction),
            ...
            y.ios && s.push('ios'),
            (S.isIE || S.isEdge) && (p.pointerEvents || p.prefixedPointerEvents) && s.push('wp8-' + t.direction),
    ...
    P = (function (e) {
      function t() {
        ...
        1 === n.length && n[0].constructor && n[0].constructor === Object ? (r = n[0]) : ((s = (a = n)[0]), (r = a[1])),
          r || (r = {}),
          (r = d.extend({}, r)),
          s && !r.el && (r.el = s),
          e.call(this, r),
        ...
        var c = d.extend({}, C);
        l.useModulesParams(c), (l.params = d.extend({}, c, k, r)), (l.originalParams = d.extend({}, l.params)), (l.passedParams = d.extend({}, r)), (l.$ = i);
        var u = i(l.params.el);
        if ((s = u[0])) {
          if (u.length > 1) {
            var h = [];
          ...
          return (
            d.extend(l, {
              ...
              touchEvents:
                ...
                p.pointerEvents ? (f = ['pointerdown', 'pointermove', 'pointerup']) : p.prefixedPointerEvents && (f = ['MSPointerDown', 'MSPointerMove', 'MSPointerUp']),
    ...
    $ = { name: 'support', proto: { support: p }, static: { support: p } },
    ...
    D = {
      ...
      attach: function (e, a) {
        ...
        s.observe(e, { attributes: void 0 === a.attributes || a.attributes, childList: void 0 === a.childList || a.childList, characterData: void 0 === a.characterData || a.characterData }), i.observer.observers.push(s);
      },
      init: function () {
        var e = this;
    ...
    A = {
      update: function (e) {
        ...
        if ((d.extend(t.virtual, { from: x, to: T, offset: E, slidesGrid: t.slidesGrid }), c === x && u === T && !e)) return t.slidesGrid !== v && E !== m && t.slides.css(g, E + 'px'), void t.updateProgress();
        ...
        else for (var k = c; k <= u; k += 1) (k < x || k > T) && t.$wrapperEl.find('.' + t.params.slideClass + '[data-swiper-slide-index="' + k + '"]').remove();
        for (var P = 0; P < h.length; P += 1) P >= x && P <= T && (void 0 === u || e ? M.push(P) : (P > u && M.push(P), P < c && C.push(P)));
    ...
    N = {
      ...
      create: function () {
        var e = this;
        d.extend(e, { virtual: { update: A.update.bind(e), appendSlide: A.appendSlide.bind(e), prependSlide: A.prependSlide.bind(e), renderSlide: A.renderSlide.bind(e), slides: e.params.virtual.slides, cache: {} } });
      },
      on: {
        beforeInit: function () {
          var e = this;
    ...
    H = {
      handle: function (a) {
        ...
        if (!(r.shiftKey || r.altKey || r.ctrlKey || r.metaKey || (e.activeElement && e.activeElement.nodeName && ('input' === e.activeElement.nodeName.toLowerCase() || 'textarea' === e.activeElement.nodeName.toLowerCase())))) {
          ...
          i.isHorizontal()
            ? ((37 !== n && 39 !== n) || (r.preventDefault ? r.preventDefault() : (r.returnValue = !1)), ((39 === n && !s) || (37 === n && s)) && i.slideNext(), ((37 === n && !s) || (39 === n && s)) && i.slidePrev())
            : ((38 !== n && 40 !== n) || (r.preventDefault ? r.preventDefault() : (r.returnValue = !1)), 40 === n && i.slideNext(), 38 === n && i.slidePrev()),
            i.emit('keyPress', n);
        }
      },
      enable: function () {
  ...
  var B = {
      ...
      disable: function () {
        ...
        if (!e.mousewheel.enabled) return !1;
        var t = e.$el;
        return 'container' !== e.params.mousewheel.eventsTarged && (t = i(e.params.mousewheel.eventsTarged)), t.off(B.event, e.mousewheel.handle), (e.mousewheel.enabled = !1), !0;
      },
    },
    X = {
      update: function () {
      ...
      init: function () {
        ...
        (s.nextEl || s.prevEl) &&
          (s.nextEl && ((e = i(s.nextEl)), a.params.uniqueNavElements && 'string' == typeof s.nextEl && e.length > 1 && 1 === a.$el.find(s.nextEl).length && (e = a.$el.find(s.nextEl))),
    ...
    Y = {
      update: function () {
        ...
        if (a.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
          ...
          if (
            (e.params.loop
              ? ((s = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup)) > r - 1 - 2 * e.loopedSlides && (s -= r - 2 * e.loopedSlides), s > o - 1 && (s -= o), s < 0 && 'bullets' !== e.params.paginationType && (s = o + s))
            ...
            if (
              (a.dynamicBullets &&
                ...
                (p = ((d = l + (Math.min(c.length, a.dynamicMainBullets) - 1)) + l) / 2)),
              ...
              c.each(function (e, t) {
                ...
                n === s && r.addClass(a.bulletActiveClass),
                  a.dynamicBullets &&
                    (n >= l && n <= d && r.addClass(a.bulletActiveClass + '-main'),
                    n === l &&
                      r
                        .prev()
    ...
    V = {
      ...
      updateSize: function () {
        ...
        if (e.params.scrollbar.el && e.scrollbar.el) {
          ...
          (s = 'auto' === e.params.scrollbar.dragSize ? r * n : parseInt(e.params.scrollbar.dragSize, 10)),
            ...
            d.extend(t, { trackSize: r, divider: n, moveDivider: o, dragSize: s }),
      ...
      enableDraggable: function () {
        ...
        if (t.params.scrollbar.el) {
          ...
          p.touch
            ? (n.addEventListener(i.start, t.scrollbar.onDragStart, o), n.addEventListener(i.move, t.scrollbar.onDragMove, o), n.addEventListener(i.end, t.scrollbar.onDragEnd, l))
            : (n.addEventListener(s.start, t.scrollbar.onDragStart, o), e.addEventListener(s.move, t.scrollbar.onDragMove, o), e.addEventListener(s.end, t.scrollbar.onDragEnd, l));
        }
      },
      disableDraggable: function () {
        ...
        if (t.params.scrollbar.el) {
          var a = t.scrollbar,
            ...
            l = !(!p.passiveListener || !r.passiveListeners) && { passive: !0, capture: !1 };
          p.touch
            ? (n.removeEventListener(i.start, t.scrollbar.onDragStart, o), n.removeEventListener(i.move, t.scrollbar.onDragMove, o), n.removeEventListener(i.end, t.scrollbar.onDragEnd, l))
            : (n.removeEventListener(s.start, t.scrollbar.onDragStart, o), e.removeEventListener(s.move, t.scrollbar.onDragMove, o), e.removeEventListener(s.end, t.scrollbar.onDragEnd, l));
        }
      },
      init: function () {
        var e = this;
        if (e.params.scrollbar.el) {
          ...
          0 === n.length && ((n = i('<div class="' + e.params.scrollbar.dragClass + '"></div>')), r.append(n)), d.extend(t, { $el: r, el: r[0], $dragEl: n, dragEl: n[0] }), s.draggable && t.enableDraggable();
        }
      },
      destroy: function () {
    ...
    R = {
      ...
      onGestureStart: function (e) {
        ...
        if (((s.fakeGestureTouched = !1), (s.fakeGestureMoved = !1), !p.gestures)) {
          ...
          (s.fakeGestureTouched = !0), (r.scaleStart = R.getDistanceBetweenTouches(e));
        }
      ...
      onGestureChange: function (e) {
        ...
        i.$imageEl &&
          0 !== i.$imageEl.length &&
          (p.gestures ? (this.zoom.scale = e.scale * a.currentScale) : (a.scale = (i.scaleMove / i.scaleStart) * a.currentScale),
      ...
      onTouchStart: function (e) {
        ...
        a.$imageEl &&
          0 !== a.$imageEl.length &&
          (i.isTouched || (y.android && e.preventDefault(), (i.isTouched = !0), (i.touchesStart.x = 'touchstart' === e.type ? e.targetTouches[0].pageX : e.pageX), (i.touchesStart.y = 'touchstart' === e.type ? e.targetTouches[0].pageY : e.pageY)));
      },
      ...
      in: function (e) {
        var t,
          ...
          x = w.gesture,
          T = w.image;
        (x.$slideEl || ((x.$slideEl = b.clickedSlide ? i(b.clickedSlide) : b.slides.eq(b.activeIndex)), (x.$imageEl = x.$slideEl.find('img, svg, canvas')), (x.$imageWrapEl = x.$imageEl.parent('.' + y.containerClass))), x.$imageEl && 0 !== x.$imageEl.length) &&
          ...
          (w.currentScale = x.$imageWrapEl.attr('data-swiper-zoom') || y.maxRatio),
          e
      ...
      out: function () {
        var e = this,
          ...
          a = e.params.zoom,
          s = t.gesture;
        s.$slideEl || ((s.$slideEl = e.clickedSlide ? i(e.clickedSlide) : e.slides.eq(e.activeIndex)), (s.$imageEl = s.$slideEl.find('img, svg, canvas')), (s.$imageWrapEl = s.$imageEl.parent('.' + a.containerClass))),
          s.$imageEl &&
            0 !== s.$imageEl.length &&
            ((t.scale = 1), (t.currentScale = 1), s.$imageWrapEl.transition(300).transform('translate3d(0,0,0)'), s.$imageEl.transition(300).transform('translate3d(0,0,0) scale(1)'), s.$slideEl.removeClass('' + a.zoomedSlideClass), (s.$slideEl = void 0));
      },
      enable: function () {
        var e = this,
          t = e.zoom;
        if (!t.enabled) {
          ...
          p.gestures
            ...
            : 'touchstart' === e.touchEvents.start &&
              (e.$wrapperEl.on(e.touchEvents.start, '.swiper-slide', t.onGestureStart, a), e.$wrapperEl.on(e.touchEvents.move, '.swiper-slide', t.onGestureChange, a), e.$wrapperEl.on(e.touchEvents.end, '.swiper-slide', t.onGestureEnd, a)),
      ...
      disable: function () {
        ...
        if (t.enabled) {
          ...
          p.gestures
            ...
            : 'touchstart' === e.touchEvents.start &&
              (e.$wrapperEl.off(e.touchEvents.start, '.swiper-slide', t.onGestureStart, a), e.$wrapperEl.off(e.touchEvents.move, '.swiper-slide', t.onGestureChange, a), e.$wrapperEl.off(e.touchEvents.end, '.swiper-slide', t.onGestureEnd, a)),
    ...
    q = {
      ...
      load: function () {
        ...
        else if (l > 1) for (var c = r; c < r + l; c += 1) d(c) && e.lazy.loadInSlide(c);
    ...
    W = {
      ...
      setTransition: function (e, t) {
        ...
        if (Array.isArray(s)) for (a = 0; a < s.length; a += 1) s[a] !== t && s[a] instanceof P && r(s[a]);
    ...
    j = {
      ...
      onEnterKey: function (e) {
        ...
        if (13 === e.keyCode) {
          var s = i(e.target);
          t.navigation && t.navigation.$nextEl && s.is(t.navigation.$nextEl) && ((t.isEnd && !t.params.loop) || t.slideNext(), t.isEnd ? t.a11y.notify(a.lastSlideMessage) : t.a11y.notify(a.nextSlideMessage)),
            t.navigation && t.navigation.$prevEl && s.is(t.navigation.$prevEl) && ((t.isBeginning && !t.params.loop) || t.slidePrev(), t.isBeginning ? t.a11y.notify(a.firstSlideMessage) : t.a11y.notify(a.prevSlideMessage)),
    ...
    Q = {
      setTranslate: function () {
        ...
        p.shadow &&
          (c
            ? (0 === (e = s.find('.swiper-cube-shadow')).length && ((e = i('<div class="swiper-cube-shadow"></div>')), s.append(e)), e.css({ height: n + 'px' }))
        ...
        for (var v = 0; v < r.length; v += 1) {
          ...
          if ((w <= 1 && w > -1 && ((h = 90 * m + 90 * w), l && (h = 90 * -m - 90 * w)), f.transform(E), p.slideShadows)) {
            ...
            0 === C.length && ((C = i('<div class="swiper-slide-shadow-' + (c ? 'left' : 'top') + '"></div>')), f.append(C)),
              0 === M.length && ((M = i('<div class="swiper-slide-shadow-' + (c ? 'right' : 'bottom') + '"></div>')), f.append(M)),
        ...
        if ((s.css({ '-webkit-transform-origin': '50% 50% -' + d / 2 + 'px', '-moz-transform-origin': '50% 50% -' + d / 2 + 'px', '-ms-transform-origin': '50% 50% -' + d / 2 + 'px', 'transform-origin': '50% 50% -' + d / 2 + 'px' }), p.shadow))
          if (c) e.transform('translate3d(0px, ' + (n / 2 + p.shadowOffset) + 'px, ' + -n / 2 + 'px) rotateX(90deg) rotateZ(0deg) scale(' + p.shadowScale + ')');
            ...
            var k = Math.abs(h) - 90 * Math.floor(Math.abs(h) / 90),
              ...
              $ = p.shadowScale / P,
              L = p.shadowOffset;
            e.transform('scale3d(' + z + ', 1, ' + $ + ') translate3d(0px, ' + (o / 2 + L) + 'px, ' + -o / 2 / $ + 'px) rotateX(-90deg)');
          }
      ...
      setTranslate: function () {
        for (var e = this, t = e.slides, a = e.rtlTranslate, s = 0; s < t.length; s += 1) {
          ...
          var o = -180 * n,
            ...
            p = 0;
          if ((e.isHorizontal() ? a && (o = -o) : ((p = d), (d = 0), (l = -o), (o = 0)), (r[0].style.zIndex = -Math.abs(Math.round(n)) + t.length), e.params.flipEffect.slideShadows)) {
            ...
            0 === c.length && ((c = i('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? 'left' : 'top') + '"></div>')), r.append(c)),
              0 === u.length && ((u = i('<div class="swiper-slide-shadow-' + (e.isHorizontal() ? 'right' : 'bottom') + '"></div>')), r.append(u)),
      ...
      setTranslate: function () {
        for (
          ...
          if ((m.transform(S), (m[0].style.zIndex = 1 - Math.abs(Math.round(b))), o.slideShadows)) {
            ...
            0 === C.length && ((C = i('<div class="swiper-slide-shadow-' + (l ? 'left' : 'top') + '"></div>')), m.append(C)),
              0 === M.length && ((M = i('<div class="swiper-slide-shadow-' + (l ? 'right' : 'bottom') + '"></div>')), m.append(M)),
    ...
    te = {
      init: function () {
        ...
        t.swiper instanceof a
          ...
          : d.isObject(t.swiper) && ((e.thumbs.swiper = new a(d.extend({}, t.swiper, { watchSlidesVisibility: !0, watchSlidesProgress: !0, slideToClickedSlide: !1 }))), (e.thumbs.swiperCreated = !0)),
      ...
      onThumbClick: function () {
        ...
        if (t) {
          var a = t.clickedIndex,
            s = t.clickedSlide;
          if (!((s && i(s).hasClass(e.params.thumbs.slideThumbActiveClass)) || void 0 === a || null === a)) {
            var r;
      ...
      update: function (e) {
        ...
        if (a) {
          ...
          if (t.realIndex !== a.realIndex) {
            ...
            a.visibleSlidesIndexes.indexOf(s) < 0 && (a.params.centeredSlides ? (s = s > r ? s - Math.floor(i / 2) + 1 : s + Math.floor(i / 2) - 1) : s > r && (s = s - i + 1), a.slideTo(s, e ? 0 : void 0));
          }
          var l = 1,
    ...
    ae = [
      ...
      G,
      {
        ...
        create: function () {
          var e = this;
          d.extend(e, { mousewheel: { enabled: !1, enable: B.enable.bind(e), disable: B.disable.bind(e), handle: B.handle.bind(e), handleMouseEnter: B.handleMouseEnter.bind(e), handleMouseLeave: B.handleMouseLeave.bind(e), lastScrollTime: d.now() } });
        },
        on: {
          init: function () {
      ...
      },
      {
        ...
        create: function () {
          var e = this;
          d.extend(e, { navigation: { init: X.init.bind(e), update: X.update.bind(e), destroy: X.destroy.bind(e), onNextClick: X.onNextClick.bind(e), onPrevClick: X.onPrevClick.bind(e) } });
        },
        on: {
          init: function () {
      ...
      },
      {
        ...
        create: function () {
          var e = this;
          d.extend(e, { pagination: { init: Y.init.bind(e), render: Y.render.bind(e), update: Y.update.bind(e), destroy: Y.destroy.bind(e), dynamicBulletIndex: 0 } });
        },
        on: {
          init: function () {
          ...
          click: function (e) {
            var t = this;
            t.params.pagination.el && t.params.pagination.hideOnClick && t.pagination.$el.length > 0 && !i(e.target).hasClass(t.params.pagination.bulletClass) && t.pagination.$el.toggleClass(t.params.pagination.hiddenClass);
          },
        },
      },
      {
      ...
      },
      {
        ...
        create: function () {
          d.extend(this, { parallax: { setTransform: F.setTransform.bind(this), setTranslate: F.setTranslate.bind(this), setTransition: F.setTransition.bind(this) } });
        },
        on: {
          beforeInit: function () {
      ...
      },
      {
        ...
        create: function () {
          var e = this;
          d.extend(e, { controller: { control: e.params.controller.control, getInterpolateFunction: W.getInterpolateFunction.bind(e), setTranslate: W.setTranslate.bind(e), setTransition: W.setTransition.bind(e) } });
        },
        on: {
          update: function () {
      ...
      },
      {
        ...
        create: function () {
          var e = this;
          d.extend(e, { a11y: { liveRegion: i('<span class="' + e.params.a11y.notificationClass + '" aria-live="assertive" aria-atomic="true"></span>') } }),
      ...
      },
      {
        ...
        create: function () {
          var e = this;
          d.extend(e, { history: { init: U.init.bind(e), setHistory: U.setHistory.bind(e), setHistoryPopState: U.setHistoryPopState.bind(e), scrollToSlide: U.scrollToSlide.bind(e), destroy: U.destroy.bind(e) } });
        },
        on: {
          init: function () {
      ...
      },
      {
        ...
        create: function () {
          var e = this;
          d.extend(e, { hashNavigation: { initialized: !1, init: K.init.bind(e), destroy: K.destroy.bind(e), setHash: K.setHash.bind(e), onHashCange: K.onHashCange.bind(e) } });
        },
        on: {
          init: function () {
